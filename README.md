...
[Based on Media.Monks Frontend Coding Standards](https://github.com/mediamonks/frontend-coding-standards)
...
[Pull Request Guidelines](https://github.com/Infoland-kz/frontend-coding-standards/blob/main/creating-pull-requests.md).
...
At Infoland, we decided to stick with what is included in Node.js - [npm](https://github.com/npm/cli).
